...
PUZZLE_BANK = [
    ...
    ("prison", "keypad", "The Warden's Tally",
     ...
     0.40, {"code": "0713", "clue": "Count the cell block fixtures in sequence: barred cells, hanging chains, interrogation chairs, and exit doors."}),
    ("laboratory", "keypad", "Specimen Log 47",
     "A blood-flecked logbook lies open beside the shattered tanks.",
     0.45, {"code": "0047", "clue": "Inspect the laboratory inventory: specimen fluid tanks, lab benches, chemical beakers, and light fixtures."}),
    ("hospital", "keypad", "Ward Chart 3-47",
     "A patient chart still hangs at the foot of an empty bed.",
     0.50, {"code": "0347", "clue": "Cross-reference the patient chart, room number, and flatline time on the monitor."}),
    ...
    ("castle", "sequence", "The Heraldic Order",
     ...
     0.60, {"sequence": ["key", "flame", "raven", "skull"], "clue": "The Oath of Chivalry:\nI. The golden key that unlocks the realm\nII. The flickering flame of honor\nIII. The black wings of night\nIV. The silent marker of mortality"}),
    ("bunker", "keypad", "The Cold-War Frequency",
     "The radio still hums on a dead channel; a code is scrawled on the housing.",
     0.70, {"code": "1962", "clue": "The final transmission frequency corresponds to the historical year scrawled on the radio console."}),
