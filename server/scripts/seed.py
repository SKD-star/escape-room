...
PUZZLE_BANK = [
    ...
    ("mansion", "keypad", "Grandfather Clock Lock",
     ...
     0.55, {"code": "52614", "clue": "The Heir's Cipher:\nI. Ancestral Portraits in gallery (5)\nII. Dining Chairs set at the table (2)\nIII. Flames flickering on grand chandelier (6)\nIV. Stopped Grandfather Clock (1)\nV. Decorative Wall Mirrors (4)"}),
    ...
    ("bunker", "keypad", "The Cold-War Frequency",
     ...
     0.70, {"code": "23415", "clue": "Quartermaster's Supply Ledger:\nI. Metal Bunk Bed Frames (2)\nII. Wooden Supply Crates in corner (3)\nIII. Wire-Caged Ceiling Lights (4)\nIV. Master Radio Transceiver Console (1)\nV. Steel Bulkhead Wall Panels (5)"}),
